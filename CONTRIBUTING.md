# Contributing to CasperLabs-Wise-LiquidityTransformer-jsClient

The following is a set of rules and guidelines for contributing to this repo. Please feel free to propose changes to this document in a pull request.

## Submitting issues

If you have questions about how to use CasperLabs-Wise-LiquidityTransformer-jsClient, please direct these to the related discord channels and do not file an issue:
